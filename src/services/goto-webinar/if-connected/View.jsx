...
const t = scoped('integrations.services.goto-webinar.if-connected.View', {
	...
	description: {
		canNotConnect:
			'Please contact your site administrator for assistance. Administrators can connect integrations on the Advanced tab of the Site Administration view.',
		canConnect:
	...
	error:
		'GoToWebinar is not configured for this site, please contact support.',
	connect: 'Connect',
...
class GotoWebinarIsConnected extends React.Component {
	...
	render() {
		...
		return (
			<div
				className={cx(
					'nti-integrations-goto-webinar-if-connected',
					className,
					{ connected }
				)}
			>
		...
		return (
			<div className="content">
				...
				<div className="description">
					{canConnect
						? t('description.canConnect')
						: t('description.canNotConnect')}
				</div>
				{canConnect && (
