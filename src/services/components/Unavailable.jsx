...
const t = scoped('integrations.services.components.Unavailable', {
	...
	comingSoon: 'For questions, or to check when this integration will be available please contact <a href="mailto:support@nextthought.com?subject=%(subject)s">support@nextthought.com</a>'
});
